...
<html lang="en" class="layout-wide customizer-hide" data-assets-path="../assets/" data-template="vertical-menu-template-free">
  <head>
    ...
    <meta name="description" content="Admin login with OTP verification." />
  ...
  <body>
        ...
        <div class="authentication-inner">
          <div class="card px-sm-6 px-0">
            <div class="card-body">
              ...
              <p class="mb-4">Enter your admin credentials, then verify using OTP if required.</p>

              <form id="formAuthentication" class="mb-6" action="{{ route('admin.login') }}" method="POST" data-step="credentials">
                @csrf
                ...
                <div id="otpVerification" class="mb-3 d-none">
    ...
    <script>
      ...
      function showMessage(message, type = 'info') {
        messageBox.innerHTML = `<div class="alert alert-${type} mb-0">${message}</div>`;
      }
      ...
      form.addEventListener('submit', async function (event) {
        ...
        submitButton.textContent = step === 'otp' ? 'Verifying OTP...' : 'Signing in...';
        ...
        try {
          ...
          if (data.requires_otp) {
            setStep('otp');
            showMessage(data.message || 'OTP verification required.', 'warning');
            return;
          }
          ...
          submitButton.textContent = form.dataset.step === 'otp' ? 'Verify OTP' : 'Login';
        }
      });
    </script>
  </body>
