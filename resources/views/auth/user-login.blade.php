            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-heading fw-bold">SMS Panel</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-1">Bulk SMS Marketing Platform</h4>
              <p class="mb-6">Sign in to manage campaigns, contacts, and messaging delivery</p>

              <form id="formAuthentication" class="mb-6" method="POST" action="{{ route('login') }}" data-step="credentials">
                @csrf
                ...
                @endif
                <div id="credentialFields" class="mb-6">
                  <div class="mb-6">
                ...
                <div id="otpVerification" class="mb-6 d-none">
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        ...
        @if ($errors->any())
          ...
          bladeErrors.forEach(function (message, index) {
            setTimeout(function () {
        ...
        let currentStep = form.getAttribute('data-step') || 'credentials';
        ...
        form.addEventListener('submit', async function (event) {
          ...
          if (currentStep === 'credentials') {
            ...
            if (!rememberField.checked) {
              errors.push('Please check Remember Me to continue.');
            }
          }
          ...
          if (currentStep === 'otp') {
            ...
            } else if (!/^\d{6}$/.test(otpField.value.trim())) {
          ...
          const endpoint = currentStep === 'otp'
            ? '{{ route('login.verify_otp') }}'
            : '{{ route('login') }}';

          const formData = new FormData(form);
          const submitText = currentStep === 'otp' ? 'Verifying OTP...' : 'Signing in...';
          ...
          try {
            ...
            submitButton.textContent = currentStep === 'otp' ? 'Verify OTP' : 'Login';
            ...
            if (data.success) {
              const redirectUrl = data.redirect || '{{ route('user.dashboard') }}';
