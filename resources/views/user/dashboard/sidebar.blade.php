...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  <div class="app-brand demo">
    <a href="{{ route('user.dashboard') }}" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">SMS Partner</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div class="text-truncate">SMS Partner</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item">
        ...
        <li class="menu-item">
          <a href="{{ route('user.dashboard.contacts') }}" class="menu-link">
            <div class="text-truncate">Contacts</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{ route('user.dashboard.sender_ids') }}" class="menu-link">
            <div class="text-truncate">Sender IDs</div>
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('user.dashboard.settings.profile') }}" class="menu-link">
            <div class="text-truncate">Profile</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{ route('user.dashboard.settings.api_keys') }}" class="menu-link">
            <div class="text-truncate">API Keys</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="{{ route('user.dashboard.settings.security') }}" class="menu-link">
            <div class="text-truncate">Security</div>
          </a>
        </li>
      </ul>
    </li>
